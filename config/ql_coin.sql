...
Source Server         : 46.8.179.136
Source Server Version : 50728
Source Host           : 46.8.179.136:3306
Source Database       : ql_coin

Target Server Type    : MYSQL
Target Server Version : 50728
File Encoding         : 65001

Date: 2020-09-13 10:38:38
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='代码生成业务表';
...
) ENGINE=InnoDB AUTO_INCREMENT=497 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='代码生成业务表字段';
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'NTT-TG-00879D1599538481923', '1599964728096', '15000');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', null, '1599538490000', '-1', '5', 'PAUSED', 'CRON', '1599538482000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', null, '1599538485000', '-1', '5', 'PAUSED', 'CRON', '1599538482000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', null, '1599538500000', '-1', '5', 'PAUSED', 'CRON', '1599538482000', '0', null, '2', '');
...
CREATE TABLE `sys_dictionaries` (
  ...
  `uvalue` varchar(255) NOT NULL COMMENT '值',
  `info` varchar(50) DEFAULT NULL COMMENT '描述信息',
...
) ENGINE=InnoDB AUTO_INCREMENT=224 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='字典数据表';
...
) ENGINE=InnoDB AUTO_INCREMENT=132 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='字典类型表';
...
) ENGINE=InnoDB AUTO_INCREMENT=204 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='定时任务调度日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2290 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', 'BSEX', '00', 'ry@163.com', '15888888888', '1', '/profile/avatar/2020/04/01/11e1f28d640d8a9c4f11d6365b1c3e0c.png', 'f9f3d355b75357b790191f10e634bb86', '079277', '0', '0', '1.86.244.34', '2020-09-12 21:00:20', 'admin', '2018-03-16 11:33:00', 'ry', '2020-09-12 21:00:19', '管理员');
...
CREATE TABLE `t_balance` (
  ...
  `blocked_balance` decimal(60,30) unsigned zerofill DEFAULT '000000000000000000000000000000.000000000000000000000000000000' COMMENT '冻结余额',
  `balance` decimal(60,30) unsigned zerofill DEFAULT '000000000000000000000000000000.000000000000000000000000000000' COMMENT '余额',
  `assets_blocked_balance` decimal(60,30) unsigned zerofill DEFAULT '000000000000000000000000000000.000000000000000000000000000000' COMMENT '资产冻结',
  `assets_balance` decimal(60,30) unsigned zerofill DEFAULT '000000000000000000000000000000.000000000000000000000000000000',
  `token_balance` decimal(60,30) unsigned zerofill DEFAULT '000000000000000000000000000000.000000000000000000000000000000' COMMENT '合约可用',
  `token_blocked_balance` decimal(60,30) unsigned zerofill DEFAULT '000000000000000000000000000000.000000000000000000000000000000' COMMENT '合约冻结',
  `fb_balance` decimal(60,30) unsigned zerofill DEFAULT '000000000000000000000000000000.000000000000000000000000000000',
  `fb_blocked_balance` decimal(60,30) unsigned zerofill DEFAULT '000000000000000000000000000000.000000000000000000000000000000',
  `raise_balance` decimal(60,30) unsigned zerofill DEFAULT '000000000000000000000000000000.000000000000000000000000000000' COMMENT '私募冻结',
  `chain_balance` decimal(60,30) unsigned zerofill DEFAULT '000000000000000000000000000000.000000000000000000000000000000' COMMENT '恋上资产',
  `remarks` varchar(150) DEFAULT NULL COMMENT '备注',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `user_id_currency_unique` (`user_id`,`currency`) USING BTREE,
...
CREATE TABLE `t_banner` (
  `id` varchar(32) NOT NULL,
  `banner_url` varchar(255) DEFAULT NULL COMMENT 'banner图地址',
  `link_url` varchar(255) DEFAULT NULL COMMENT '跳转URL',
  `banner_type` varchar(64) DEFAULT NULL COMMENT '状态 DATA_BANNER：主页  PROJECT_BANNER：项目方  	PROJECT_BANNER：邀请返佣',
  `global` varchar(64) DEFAULT NULL COMMENT '国际化 CHINESE_SIM 中文 	CHINESE_TRAD 繁体中文 	ENGLISH英文',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `create_user` varchar(64) DEFAULT NULL COMMENT '创建人',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `update_user` varchar(64) DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='币币-banner图';
...
CREATE TABLE `t_bibi_day_record` (
  ...
  `sum_bibi_buy` decimal(32,8) DEFAULT NULL COMMENT '币币总购买',
  `sum_bibi_sell` decimal(32,8) DEFAULT NULL COMMENT '币币总出售',
  `create_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=401241 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='币种交易量';
...
CREATE TABLE `t_brokerage_record` (
  ...
  `consume_user_id` varchar(32) DEFAULT NULL COMMENT '消费者userId',
  `brokerage_user_id` varchar(32) NOT NULL COMMENT '回扣的userId',
  `currency` varchar(16) DEFAULT NULL COMMENT '消费币种',
  ...
  `brokerage_phone` varchar(50) DEFAULT NULL,
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_coin_token` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='币种信息';
...
CREATE TABLE `t_commission` (
  `id` varchar(32) NOT NULL,
  `commission_rate` decimal(10,4) DEFAULT NULL COMMENT '返佣比率',
  `max_money` decimal(10,0) DEFAULT NULL COMMENT '最大返佣金额',
...
CREATE TABLE `t_contract_mul` (
  `id` varchar(32) NOT NULL,
  `pairs_name` varchar(30) DEFAULT NULL COMMENT '交易对名称',
  `contract_mul` decimal(10,8) DEFAULT NULL COMMENT '合约乘数',
  `force_price` decimal(10,8) DEFAULT NULL COMMENT '强平价格',
  `maker_fee` decimal(10,8) DEFAULT NULL COMMENT '开仓手续费',
  `taker_fee` decimal(10,8) DEFAULT NULL COMMENT '平仓手续费',
  `force_fee` decimal(10,8) DEFAULT NULL COMMENT '强平手续费',
  `trade_fee` decimal(10,8) DEFAULT NULL COMMENT '交易手续费',
  `withdraw_fee` decimal(10,8) DEFAULT NULL COMMENT '提币手续费',
  `ensure` decimal(10,4) DEFAULT NULL COMMENT '维持保证金比率',
...
CREATE TABLE `t_contract_order` (
  `id` varchar(32) NOT NULL,
  `pairs_name` varchar(20) DEFAULT NULL COMMENT '交易对名称',
  `main_cur` varchar(15) DEFAULT NULL,
  `coin_name` varchar(15) DEFAULT NULL COMMENT '币种名称',
  `lever_num` decimal(10,0) DEFAULT NULL COMMENT '杠杆倍数',
  `lever_desc` varchar(20) DEFAULT NULL COMMENT '杠杆描述',
  `margin` decimal(20,8) DEFAULT NULL COMMENT '保证金',
  `contract_hands` decimal(30,0) DEFAULT NULL COMMENT '手数',
  `price` decimal(50,8) DEFAULT NULL COMMENT '持仓价格',
  `match_price` decimal(50,8) DEFAULT NULL COMMENT '撮合价格',
  `match_fee` decimal(50,8) DEFAULT NULL,
  `close_type` varchar(32) DEFAULT NULL,
  `price_type` varchar(30) DEFAULT NULL COMMENT '价格类型',
  `coin_num` decimal(30,8) DEFAULT NULL COMMENT '数量',
  `is_contract_hands` decimal(30,8) DEFAULT NULL COMMENT '可用合约乘数',
  `order_state` varchar(20) DEFAULT NULL COMMENT '状态',
  `take_fee` decimal(30,8) DEFAULT NULL,
  `order_type` varchar(32) DEFAULT NULL COMMENT '订单类型',
  `member` varchar(32) DEFAULT NULL COMMENT '用户',
  `trade_type` varchar(15) DEFAULT NULL COMMENT '交易类型',
  `contract_mul_id` varchar(32) DEFAULT NULL COMMENT '合约配置 ID',
  `lever_id` varchar(32) DEFAULT NULL COMMENT '杠杆 ID',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `member_pairs` (`member`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_day_balance_sum` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bkt_sum` decimal(32,8) DEFAULT '0.00000000',
  `voice_sum` decimal(32,8) DEFAULT '0.00000000',
  `bkt_day_up` decimal(32,8) DEFAULT '0.00000000' COMMENT 'BKT每日流入',
  `bkt_to_voice` decimal(32,8) DEFAULT '0.00000000',
  `voice_to_bkt` decimal(32,8) DEFAULT '0.00000000',
  `suanli` decimal(32,8) DEFAULT '0.00000000',
  `zhitui` decimal(32,8) DEFAULT NULL,
  `bkt_fee` decimal(32,8) DEFAULT '0.00000000' COMMENT '转账手续费',
  `voice_fee` decimal(32,8) DEFAULT '0.00000000',
  `create_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='资产统计';
...
CREATE TABLE `t_deposit_history` (
  ...
  `member` varchar(50) DEFAULT NULL COMMENT '用户id',
  `block_number` varchar(255) DEFAULT NULL COMMENT '区块高度',
  `tx_hash` varchar(255) DEFAULT NULL COMMENT '交易hash',
  `contract` varchar(255) DEFAULT NULL COMMENT '合约地址',
  `from_address` varchar(255) DEFAULT NULL COMMENT 'FROM',
  `to_address` varchar(255) DEFAULT NULL COMMENT 'TO',
  `coin` varchar(255) DEFAULT NULL COMMENT '币种',
  `amount` varchar(255) DEFAULT NULL COMMENT '充值额',
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `t_entrust` (
  `id` varchar(32) NOT NULL,
  `pairs` varchar(32) DEFAULT NULL,
  `main_cur` varchar(50) DEFAULT NULL,
  `token_cur` varchar(30) DEFAULT NULL,
  `pairs_name` varchar(30) DEFAULT NULL,
  `price` decimal(50,8) DEFAULT NULL,
  `match_price` decimal(50,8) unsigned zerofill DEFAULT NULL COMMENT '成交价格',
  `count` decimal(50,8) DEFAULT NULL,
  `percentage_count` decimal(20,8) DEFAULT NULL,
  `match_count` decimal(50,8) unsigned zerofill DEFAULT '000000000000000000000000000000000000000000.00000000' COMMENT '成交数量',
  `surplus_count` decimal(50,8) DEFAULT NULL,
  `member` varchar(32) DEFAULT NULL,
  `member_type` varchar(30) DEFAULT NULL,
  `trade_rate` decimal(20,8) DEFAULT NULL,
  `entrust_type` varchar(20) DEFAULT NULL COMMENT '委托类型',
  `method_type` varchar(20) DEFAULT NULL COMMENT '成交方式',
  `price_type` varchar(20) DEFAULT NULL,
  `state` varchar(20) DEFAULT NULL COMMENT '状态',
  `trade_fee` decimal(20,8) DEFAULT NULL COMMENT '手续费',
  `match_member` varchar(32) DEFAULT NULL COMMENT '撮合方',
  `match_fee` decimal(20,8) DEFAULT NULL,
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `fk_state_search` (`state`) USING BTREE,
  KEY `fk_member_search` (`member`) USING BTREE,
  KEY `fk_pairs_name_search` (`pairs_name`) USING BTREE,
  KEY `fk_pairs_member_state` (`pairs_name`,`member`,`state`) USING BTREE,
  KEY `fk_id_state` (`id`,`state`) USING BTREE,
  KEY `fk_member_pairs` (`member`,`pairs_name`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_entrust_history` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `fk_state_search` (`state`) USING BTREE,
  KEY `fk_member` (`member`) USING BTREE,
  KEY `fk_member_pairs_name` (`member`,`pairs_name`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_extract_coin` (
  `id` varchar(32) NOT NULL,
  `member` varchar(32) DEFAULT NULL COMMENT '用户id',
  `balance` decimal(50,8) DEFAULT NULL COMMENT '数量',
  `handling_fee` decimal(20,8) NOT NULL DEFAULT '0.00000000' COMMENT '手续费',
  `currency` varchar(20) DEFAULT NULL COMMENT '币种',
  `wallet` varchar(200) DEFAULT NULL COMMENT '提币地址',
  `state` varchar(16) DEFAULT NULL COMMENT '审核中CREATE;审核通过PASS;拒绝REJECT',
  `hex` varchar(200) NOT NULL DEFAULT '' COMMENT 'php:交易hex/交易ID',
  `view_in_explorer` varchar(500) NOT NULL DEFAULT '' COMMENT 'php:交易区块页面',
  `from_address` varchar(200) NOT NULL DEFAULT '' COMMENT 'php:出方地址',
  `to_address` varchar(200) NOT NULL DEFAULT '' COMMENT 'php:收方地址',
  `token_number` varchar(100) NOT NULL DEFAULT '' COMMENT 'php:转账数量',
  `extract_time` datetime DEFAULT NULL COMMENT 'php:时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_fabi_day_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `currency` varchar(20) DEFAULT NULL COMMENT '币种',
  `sum_buy` decimal(32,8) DEFAULT NULL COMMENT '当日购买',
  `sum_sell` decimal(32,8) DEFAULT NULL COMMENT '当日出售',
  `create_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=56567 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='法币交易统计';
...
CREATE TABLE `t_lever` (
  `id` varchar(32) NOT NULL,
  `lever` bigint(10) DEFAULT NULL COMMENT '倍数',
  `lever_desc` varchar(10) DEFAULT NULL COMMENT '倍数描述',
  `pairs_name` varchar(20) DEFAULT NULL COMMENT '交易对',
  `hands_max` bigint(5) DEFAULT NULL COMMENT '手',
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_member` (
  ...
  `wel_member` varchar(32) DEFAULT NULL COMMENT '邀请人id',
  `brokerage` decimal(20,8) NOT NULL DEFAULT '0.00000000' COMMENT '佣金',
  `wel_code` varchar(20) DEFAULT NULL COMMENT '邀请码',
  `pay_password` varchar(100) DEFAULT '' COMMENT '支付密码',
  `type` varchar(16) DEFAULT NULL COMMENT '账号类型:INTERNAL内部的,EXTERNAL外部的',
  `uname` varchar(100) DEFAULT NULL,
  `sex` varchar(20) DEFAULT NULL,
  `birth` varchar(100) DEFAULT NULL,
  `card_no` varchar(100) DEFAULT NULL,
  `address` varchar(200) DEFAULT NULL,
  `quick_mark` varchar(300) DEFAULT NULL,
  `broker` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是(1)否(0)',
  `broker_grade_one` varchar(32) NOT NULL DEFAULT '' COMMENT '经纪人等级一',
  `broker_grade_two` varchar(32) NOT NULL DEFAULT '' COMMENT '经纪人等级二',
  `broker_grade_three` varchar(32) NOT NULL DEFAULT '' COMMENT '经纪人等级三',
  `node_path` text COMMENT '邀请节点路径',
  `nick_name` varchar(50) DEFAULT NULL,
  `pay_wechat` varchar(300) DEFAULT NULL,
  `pay_aliay` varchar(300) DEFAULT NULL,
  `wechat_name` varchar(50) DEFAULT NULL,
  `aliay_name` varchar(50) DEFAULT NULL,
  `side_link` varchar(300) DEFAULT NULL,
  `positive_link` varchar(300) DEFAULT NULL,
  `card_state` varchar(50) DEFAULT NULL,
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `store_name` varchar(100) DEFAULT '' COMMENT '商家昵称',
  `bank_user_name` varchar(100) DEFAULT NULL,
  `bank_name` varchar(50) DEFAULT NULL,
  `bank_address` varchar(150) DEFAULT NULL,
  `bank_card` varchar(100) DEFAULT NULL,
  `fb_status` varchar(100) DEFAULT 'NORMAL' COMMENT '法币是否可用''NORMAL''可用，UNNORMAL 不可用',
  `store_state` varchar(50) DEFAULT 'NO',
  `salt` varchar(255) DEFAULT NULL COMMENT '密码盐',
  `area_code` varchar(10) DEFAULT NULL COMMENT '区号',
  `hand_link` varchar(300) DEFAULT NULL COMMENT '手持身份证照片',
  `user_status` varchar(30) DEFAULT NULL COMMENT '封号状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_message_record` (
  ...
  `create_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='短信邮箱发送记录';
...
CREATE TABLE `t_notice` (
  ...
  `img_url` varchar(255) DEFAULT NULL COMMENT '公告图地址',
  `link_url` varchar(255) DEFAULT '' COMMENT '跳转地址',
  `notice_type` varchar(64) DEFAULT NULL COMMENT 'OFFICIAL:官方公告 NEWS：新闻资讯',
  `is_favorite` varchar(64) DEFAULT NULL COMMENT '收藏状态(1:收藏 0：未收藏)',
  `read_count` int(255) DEFAULT '0' COMMENT '浏览量',
  `global` varchar(64) DEFAULT NULL COMMENT '国际化 CHINESE_SIM 中文 	CHINESE_TRAD 繁体中文 	ENGLISH英文',
  `bak_text` varchar(1024) DEFAULT NULL COMMENT '备用文本',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `create_user` varchar(255) DEFAULT NULL COMMENT '创建人',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `update_user` varchar(255) DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='币币-公告';
...
CREATE TABLE `t_order` (
  ...
  `num` decimal(32,8) DEFAULT NULL COMMENT '数量',
  `one_price` decimal(32,2) DEFAULT NULL COMMENT '单价',
  `status` varchar(10) DEFAULT 'NORMAL' COMMENT 'NORMAL 未付款  TRADING 交易中  SUCCEED 交易成功  FALL交易失败',
  `create_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `t_order_price` (
  ...
  `buy_member` varchar(32) DEFAULT NULL,
  `sell_member` varchar(32) DEFAULT NULL,
  `one_price` decimal(32,8) DEFAULT NULL,
  `num` decimal(32,8) DEFAULT NULL,
  `pay_type` varchar(32) DEFAULT NULL,
  `status` varchar(32) DEFAULT 'START' COMMENT 'START 币已冻结 PAYMENT 已付款  SUCCEED 交易成功  FALL交易失败 BACK 已取消',
  `complaint_status` varchar(32) DEFAULT 'APPEAL',
  `complaint_user` varchar(32) DEFAULT NULL,
  ...
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='下单表';
...
CREATE TABLE `t_otc_currenct_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `currency` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
  `sort` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '排序',
  `create_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='法币币种配置表';
...
CREATE TABLE `t_otc_order` (
  ...
  `member` varchar(32) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '用户',
  `member_fb_name` varchar(32) CHARACTER SET utf8 DEFAULT '' COMMENT '用户法币昵称',
  `currency` varchar(32) CHARACTER SET utf8 NOT NULL COMMENT '币种',
  `num` decimal(32,8) DEFAULT NULL,
  `up_down_number` decimal(32,8) NOT NULL,
  `min_price` decimal(32,8) DEFAULT NULL COMMENT '最小成交价格',
  `extremum` decimal(32,8) DEFAULT NULL,
  `remarks` varchar(255) CHARACTER SET utf8 DEFAULT '' COMMENT '交易说明',
  `direction` varchar(32) CHARACTER SET utf8mb4 NOT NULL COMMENT '方向',
  `pay_type` varchar(100) CHARACTER SET utf8mb4 NOT NULL COMMENT '收款方式',
  `status` varchar(20) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '订单状态',
  `auto_status` varchar(20) COLLATE utf8_croatian_ci DEFAULT NULL,
  `auto_msg` varchar(255) CHARACTER SET utf8 DEFAULT '',
  `freeze` decimal(32,8) DEFAULT '0.00000000',
  `deal_num` decimal(32,8) DEFAULT '0.00000000',
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_croatian_ci ROW_FORMAT=COMPACT COMMENT='法币订单表';
...
CREATE TABLE `t_otc_order_appeal` (
  `id` varchar(32) CHARACTER SET utf8mb4 NOT NULL,
  `member_id` varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL,
  `price_order_id` varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL,
  `msg` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  `pic` varchar(300) CHARACTER SET utf8mb4 DEFAULT NULL,
  `pic1` varchar(300) DEFAULT NULL,
  `status` varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='Otc申诉表';
...
CREATE TABLE `t_otc_order_price` (
  ...
  `store_id` varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '商家id',
  `order_id` varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '订单id',
  `user_direction` varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '用户买卖方向',
  `store_direction` varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '商家买卖方向',
  `num` decimal(32,8) DEFAULT NULL COMMENT '下单数量',
  `price` decimal(32,8) DEFAULT NULL COMMENT '价格',
  `total_price` decimal(32,8) DEFAULT NULL COMMENT '总价',
  `pay_type` varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL,
  `status` varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL,
  `currency` varchar(32) CHARACTER SET utf8mb4 NOT NULL,
  `appeal_status` varchar(32) CHARACTER SET utf8mb4 DEFAULT '' COMMENT '申诉状态',
  `appeal_user_id` varchar(32) CHARACTER SET utf8mb4 DEFAULT '',
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='下单表';
...
CREATE TABLE `t_otc_type_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(30) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '类型',
  `min` varchar(30) CHARACTER SET utf8mb4 DEFAULT NULL,
  `create_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='订单持续总时长';
...
CREATE TABLE `t_pairs` (
  `id` varchar(32) NOT NULL,
  `pairs_name` varchar(16) DEFAULT NULL COMMENT '交易对名称',
  `main_cur` varchar(12) DEFAULT NULL COMMENT '主币',
  `token_cur` varchar(32) DEFAULT NULL COMMENT '代币',
  `state` varchar(32) DEFAULT NULL COMMENT '冻结状态',
  `type` varchar(32) DEFAULT NULL COMMENT '类型',
  `contract` varchar(256) DEFAULT NULL COMMENT '项目方合约地址',
  `point` int(12) DEFAULT NULL,
  `image` varchar(255) DEFAULT NULL COMMENT 'logo',
  `sort` int(11) DEFAULT NULL,
  `open_price` decimal(20,8) DEFAULT NULL COMMENT '开盘价',
  `price` decimal(20,8) DEFAULT NULL,
  `ch_price` decimal(20,8) DEFAULT NULL,
  `volume` decimal(20,8) DEFAULT NULL,
  `open` decimal(20,8) DEFAULT NULL,
  `low_price` decimal(20,8) DEFAULT NULL,
  `hig_price` decimal(20,8) DEFAULT NULL,
  `updown` decimal(20,8) DEFAULT NULL,
  `is_top` tinyint(1) DEFAULT NULL,
  `trade_max` decimal(10,0) DEFAULT NULL COMMENT '最大交易数量',
  `trade_min` decimal(10,0) DEFAULT NULL COMMENT '最小交易数量',
  `trade_type` varchar(32) DEFAULT NULL COMMENT '币币：SPOT,合约：CONTRACT',
  `trade_rate` decimal(20,8) DEFAULT NULL,
  `main_from` varchar(16) DEFAULT NULL COMMENT 'ETH BTC',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `is_dw` varchar(255) DEFAULT NULL COMMENT '是否开启充提币类型',
  `withdraw_min` decimal(50,25) DEFAULT NULL,
  `withdraw_fee` decimal(50,25) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
-- Records of t_pairs
-- ----------------------------
INSERT INTO `t_pairs` VALUES ('0e33238e9a16497298e2ae9b50197db5', 'EOS/USDT', 'USDT', 'EOS', 'NORMAL', 'MAIN_COIN', null, null, null, '9', '0.00000000', '2.80187158', '20.24184104', '6321967.00786954', '2.78530000', '2.77300000', '2.82870000', '0.00594966', '1', null, null, 'SPOT,CONTRACT', '0.00300000', null, '2020-09-13 10:39:38', '2020-07-30 16:51:16', null, null, null);
INSERT INTO `t_pairs` VALUES ('3a67a6977e1143f5b8dcc9af7b17c9a4', 'BCH/USDT', 'USDT', 'BCH', 'NORMAL', 'MAIN_COIN', null, null, null, '8', '0.00000000', '230.74757660', '1667.01279239', '78261.57962593', '224.48000000', '224.01000000', '232.52000000', '0.02792042', '1', null, null, 'SPOT,CONTRACT', '0.00300000', null, '2020-09-13 10:39:38', '2020-07-30 16:50:40', null, null, null);
INSERT INTO `t_pairs` VALUES ('69ecb9a740a84f49a0d8347a171100e9', 'ETC/USDT', 'USDT', 'ETC', 'NORMAL', 'MAIN_COIN', null, null, null, '6', '0.00000000', '5.23437313', '37.81520524', '419676.52734979', '5.20640000', '5.17320000', '5.27980000', '0.00537284', '1', null, null, 'SPOT,CONTRACT', '0.00300000', null, '2020-09-13 10:39:38', '2020-07-30 18:25:49', null, null, null);
INSERT INTO `t_pairs` VALUES ('7a28a28c0a8d46ec91818c7c6dce9ce7', 'XRP/USDT', 'USDT', 'XRP', 'NORMAL', 'MAIN_COIN', null, null, null, '10', '0.00000000', '0.24786206', '1.79065467', '29105438.63661390', '0.24237000', '0.24228000', '0.24876000', '0.02265982', '1', '10000', '1', 'SPOT,CONTRACT', '0.00300000', null, '2020-09-13 10:39:38', '2020-07-29 15:25:43', null, null, null);
INSERT INTO `t_pairs` VALUES ('b173b6f0f350067300e147a70ca7c034', 'BTC/USDT', 'USDT', 'BTC', 'NORMAL', 'MAIN_COIN', '', null, '', '12', null, '10430.82680994', '75356.46520573', '6350.80113607', '10360.85000000', '10351.01000000', '10478.30000000', '0.00675396', '1', '1000000', '1', 'SPOT,CONTRACT', '0.00300000', 'BTC', '2020-09-13 10:39:38', '2019-12-27 13:25:27', null, null, null);
INSERT INTO `t_pairs` VALUES ('b739a726a4a04f8db5bf5ff850a9d161', 'LTC/USDT', 'USDT', 'LTC', 'NORMAL', 'MAIN_COIN', null, null, null, '10', '0.00000000', '50.44706082', '364.44974619', '333611.53982846', '48.84000000', '48.76000000', '51.30000000', '0.03290460', '1', '1000', '1', 'SPOT,CONTRACT', '0.00300000', 'usdt', '2020-09-13 10:39:38', '2020-07-29 15:24:52', null, null, null);
INSERT INTO `t_pairs` VALUES ('d578de6355125c15ff9d60079f72018b', 'ETH/USDT', 'USDT', 'ETH', 'NORMAL', 'MAIN_COIN', '', null, '', '11', null, '384.16660753', '2775.37323944', '292830.23160837', '373.23000000', '371.78000000', '388.42000000', '0.02930259', '1', '1000000', '1', 'SPOT,CONTRACT', '0.00300000', 'ETH', '2020-09-13 10:39:38', '2019-12-27 13:38:15', '1,2', null, null);
...
CREATE TABLE `t_pe_order` (
  ...
  `pe_id` varchar(50) DEFAULT NULL COMMENT 'pe项目id',
  `member` varchar(50) DEFAULT NULL COMMENT '购买份额用户id',
  `pe_name` varchar(50) DEFAULT NULL COMMENT '形目名称',
  `pe_price` decimal(20,12) DEFAULT NULL COMMENT '单价',
  `pe_num` decimal(20,12) DEFAULT NULL COMMENT '数量',
  `pe_amount` decimal(20,12) DEFAULT NULL COMMENT '总额',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_pe_project` (
  `id` varchar(50) NOT NULL COMMENT '主键',
  `order_index` int(50) DEFAULT NULL COMMENT '订单编号',
  `project_name` varchar(255) DEFAULT NULL COMMENT '项目名称',
  `project_url` varchar(255) DEFAULT NULL COMMENT '项目地址',
  `project_img` varchar(255) DEFAULT NULL COMMENT '大图',
  `start_time` datetime DEFAULT NULL COMMENT '私募开始时间',
  `end_time` datetime DEFAULT NULL COMMENT '私募结束时间',
  `now_num` decimal(20,12) DEFAULT NULL COMMENT '已经募数量',
  `sum_num` decimal(20,12) DEFAULT NULL COMMENT '私募数',
  `min_num` decimal(20,12) DEFAULT NULL COMMENT '最小数量',
  `max_num` decimal(20,12) DEFAULT NULL COMMENT '最大数量',
  `coin_pice` decimal(20,12) DEFAULT NULL COMMENT '单价',
  `coin_name` varchar(20) DEFAULT NULL COMMENT '币种名称',
  `status` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '私募状态 WAIT排队，ING正在进行，PASS结束',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `t_robot_config` (
  `id` varchar(32) NOT NULL,
  `pair_name` varchar(40) DEFAULT NULL COMMENT '交易对名称',
  `open_kine` varchar(20) DEFAULT NULL COMMENT '是否开启k线',
  `is_open` varchar(20) DEFAULT NULL COMMENT '是否开启',
  `open_tape` varchar(20) DEFAULT NULL COMMENT '是否开启盘口',
  `will_price` decimal(32,8) DEFAULT NULL COMMENT '目标价格',
  `will_time` datetime DEFAULT NULL COMMENT '目标时间',
  `bind_user` varchar(32) DEFAULT NULL COMMENT '绑定用户',
  `start_num` decimal(32,8) DEFAULT NULL COMMENT '下单数量上限',
  `end_num` decimal(32,8) DEFAULT NULL COMMENT '下单数量波动下限',
  `start_price` decimal(32,8) DEFAULT NULL COMMENT '下单价格波动上限',
  `end_price` decimal(32,8) DEFAULT NULL COMMENT '下单价格波动上限',
  `mend_num` decimal(32,8) unsigned zerofill DEFAULT NULL,
  `mstart_num` decimal(32,8) unsigned zerofill DEFAULT NULL,
  `create_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
INSERT INTO `t_robot_config` VALUES ('4', 'ETH/USDT', 'OPEN', 'OPEN', 'OPEN', null, '2020-10-24 00:00:00', null, '0.03000000', '30.00000000', '0.10010000', '0.30000000', '000000000000000000000030.00000000', '000000000000000000000000.03000000', '2020-07-30 21:06:34');
INSERT INTO `t_robot_config` VALUES ('469b03e402a14c42a8dcced5e8d28d54', 'EOS/USDT', 'OPEN', 'OPEN', 'OPEN', '0.00000000', '2020-10-24 11:25:00', null, '10.00000000', '1000.00000000', '0.00100000', '0.00300000', '000000000000000000001000.00000000', '000000000000000000000010.00000000', '2020-08-24 10:15:44');
INSERT INTO `t_robot_config` VALUES ('a6d605c3c10e49e9bb520e48a54a3345', 'XRP/USDT', 'OPEN', 'OPEN', 'OPEN', null, '2020-10-24 15:30:00', null, '10.00000000', '1000.00000000', '0.00010000', '0.00020000', '000000000000000000010000.00000000', '000000000000000000000010.00000000', '2020-08-01 20:32:46');
INSERT INTO `t_robot_config` VALUES ('be6bf9aaf54641b5aff8701db88931f1', 'ETC/USDT', 'OPEN', 'OPEN', 'OPEN', '0.00000000', '2020-10-20 15:20:00', null, '10.00000000', '1000.00000000', '0.00100000', '0.00300000', '000000000000000000001000.00000000', '000000000000000000000010.00000000', '2020-08-20 11:22:52');
...
INSERT INTO `t_robot_config` VALUES ('eda75ff8fc0e40998a768d019bd70ea3', 'LTC/USDT', 'OPEN', 'OPEN', 'OPEN', null, '2020-12-17 10:50:00', null, '5.00000000', '100.00000000', '0.00100000', '0.02000000', '000000000000000000000100.00000000', '000000000000000000000005.00000000', '2020-07-31 14:12:32');
...
CREATE TABLE `t_sys_config` (
  ...
  `param_key` varchar(255) DEFAULT NULL COMMENT '参数AK',
  `param_value` varchar(255) DEFAULT NULL COMMENT '参数SK',
...
INSERT INTO `t_sys_config` VALUES ('3fb354e42ba1422bafa813fd1a2faa4a', 'ETH节点', 'ETH_URL', 'https://mainnet.infura.io/v3/54a12236ad264a02b0560bfe9377da69', 'ETH节点', '2020-07-30 04:34:07', '2020-08-15 11:22:13');
...
CREATE TABLE `t_transfer_info` (
  ...
  `member` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户id',
  `type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '类型',
  `currency` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '币种',
...
CREATE TABLE `t_user_blance_collect` (
  ...
  `member` varchar(32) DEFAULT NULL COMMENT '用户id',
  `currency` varchar(20) DEFAULT NULL COMMENT '币种',
  `sum_chong` decimal(32,8) DEFAULT NULL COMMENT '总充值',
  `sum_ti` decimal(32,8) DEFAULT NULL COMMENT '总提币',
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1731 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户财务分析';
...
CREATE TABLE `t_user_use_logs` (
  ...
  `method_parm` varchar(500) DEFAULT NULL COMMENT '方法参数',
  `method_body` varchar(500) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=288 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='操作接口日志表';
...
CREATE TABLE `t_wallet_pool` (
  ...
  `usdt_balance` decimal(11,0) DEFAULT NULL,
  `eth_balance` decimal(11,0) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_warehouse` (
  ...
  `main_cur` varchar(30) DEFAULT NULL,
  `margin` decimal(30,8) DEFAULT NULL,
  `un_profit_loss` decimal(30,8) DEFAULT NULL,
  `profit` decimal(30,8) DEFAULT NULL,
  `profit_up` decimal(30,8) DEFAULT NULL,
  `token_price` decimal(30,8) DEFAULT NULL,
  `token_num` decimal(30,8) DEFAULT NULL,
  `is_token_num` decimal(30,8) DEFAULT NULL,
  `ave_price` decimal(30,8) DEFAULT NULL,
  `close_price` decimal(30,8) DEFAULT NULL,
  `trigger_price` decimal(30,8) DEFAULT NULL,
  `ord_price` decimal(30,8) DEFAULT NULL,
  `member` varchar(32) DEFAULT NULL,
  `trade_type` varchar(32) DEFAULT NULL,
  `avg_level` decimal(32,8) DEFAULT NULL,
  `hands` decimal(32,0) DEFAULT NULL,
  `orders` decimal(32,0) DEFAULT NULL,
  `force_price` decimal(32,8) DEFAULT NULL,
  `state` varchar(32) DEFAULT NULL,
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `hash_tree_pairs_name` (`pairs_name`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of t_warehouse
-- ----------------------------
INSERT INTO `t_warehouse` VALUES ('3202a567ccdc707889821c3961f20a1e', 'ETH/USDT', 'ETH', 'USDT', '8002.10460000', '-28773.06883288', '0.00159202', '-3.59568767', '120031.56900000', '2.00000000', '16.00000000', '282.66000000', '282.57000000', null, null, '1eddbe64c25d5ad7d0e5b0e0616cf4d4', 'OPEN_DOWN', '10.00000000', '5662', '2', null, 'CREATE', '2020-07-25 18:24:58', '2020-09-13 10:39:00');
INSERT INTO `t_warehouse` VALUES ('9e1a11d4943be3ab4e4b63572deee508', 'EOS/USDT', 'EOS', 'USDT', '4805.83169259', '-674.29298264', '-0.01450295', '-0.14030724', '574538.69545536', '5.00000000', '107.00000000', '2.80308414', '2.80511679', null, null, '448509298ab541aefd3b7628803174a1', 'OPEN_DOWN', '100.00000000', '85724', '5', null, 'CREATE', '2020-09-10 14:23:38', '2020-09-13 10:39:00');
...
CREATE TABLE `t_withdraw_history` (
  `id` varchar(50) NOT NULL,
  `member` varchar(50) DEFAULT NULL COMMENT '提币用户ID',
  `block_number` varchar(255) DEFAULT NULL COMMENT '交易区块高度',
  `tx_hash` varchar(255) DEFAULT NULL COMMENT '交易hash',
  `contract` varchar(255) DEFAULT NULL COMMENT '合约地址',
  `from_address` varchar(255) DEFAULT NULL COMMENT '转出地址',
  `status` varchar(255) DEFAULT NULL COMMENT '状态',
  `to_address` varchar(255) DEFAULT NULL COMMENT '收币地址',
  `coin` varchar(255) DEFAULT NULL COMMENT '币名',
