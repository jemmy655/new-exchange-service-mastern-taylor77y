...
public class RabbitConfig {
    ...
    @Bean
    public DirectExchange defaultExchange_token_put() {
        return new DirectExchange(RabbitConstants.TOKEN_PRICE_PUT);
    }

    @Bean
    public Queue queueTokenPut() {
        return new Queue(RabbitConstants.TOKEN_PRICE_QUEUE_PUT, true); //队列持久
    }

    @Bean
    public Binding bindingTokenPut() {
        return BindingBuilder.bind(queueTokenPut()).to(defaultExchange_token_put()).with(RabbitConstants.TOKEN_PRICE_ROUTINGKEY_PUT);
    }
