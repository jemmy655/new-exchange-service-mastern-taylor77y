...
public class AliyunClient {
    ...
    public String access_key_id = "LTAI4FhhjDAFtktG6JsGJbP9";
    //阿里云API的密钥Access Key Secret
    public String access_key_secret = "vAAQBBGbBdGoGyP7Fw4cffvkwJDfhO";
    //阿里云API的bucket名称
    public String bucket_name = "fvex";
    //阿里云API的文件夹名称
    public String folder = "fvex/";
     ...
     * @return ossClient
     */
    public AliyunClient(String endpoint, String access_key_id, String access_key_secret, String bucket_name, String folder) {
    ...
    public String sendOss(MultipartFile file) {
        try {
            ...
            String url = ossClient.generatePresignedUrl(bucket_name, folder + name + fileExtension, expiration).toString();
            ossClient.shutdown();
            return url;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public String uploadObject2OSS(InputStream is, String fileName) {
        ...
        try {
            ...
            sb.insert(7, bucket_name + ".");// 在指定的位置插入指定的字符串
