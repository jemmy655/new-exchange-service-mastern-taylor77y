...
public class OSSClientUtil {
    ...
    // accessKey
    private static String accessKeyId = "LTAI4FhhjDAFtktG6JsGJbP9";
    private static String accessKeySecret = "vAAQBBGbBdGoGyP7Fw4cffvkwJDfhO";
    // 空间
    private static String bucketName = "fvex";
    // 文件存储目录
    private static String filedir = "fvex/";
