...
public class AESUtil {
     ...
     * 生成key
     */
    //private static SecretKeySpec key = new SecretKeySpec(Md5Utils.getMD5("2IBtBXdrqC3kCBs4gaceL7nl2nnFadQv","utf-8").toLowerCase().getBytes(), ALGORITHM);
    ...
    public static String encryptData(String data, String keyStr) throws Exception {
        SecretKeySpec key = new SecretKeySpec(Md5Utils.getMD5(keyStr, "utf-8").toLowerCase().getBytes(), ALGORITHM);
        // 创建密码器
